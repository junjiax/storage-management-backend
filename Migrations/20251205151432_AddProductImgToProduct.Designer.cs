...
namespace dotnet_backend.Migrations
{
    ...
    [Migration("20251205151432_AddProductImgToProduct")]
    partial class AddProductImgToProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dotnet_backend.Models.Product", b =>
                {
                    ...
                    b.Property<string>("ProductPublicId")
                        .HasColumnType("longtext")
                        .HasColumnName("product_public_id");
            ...
            modelBuilder.Entity("dotnet_backend.Models.Inventory", b =>
                {
                    b.HasOne("dotnet_backend.Models.Product", "Product")
                        .WithOne("Inventory")
                        .HasForeignKey("dotnet_backend.Models.Inventory", "ProductId")
            ...
            modelBuilder.Entity("dotnet_backend.Models.Order", b =>
                {
                    ...
                    b.HasOne("dotnet_backend.Models.Promotion", "Promotion")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("dotnet_backend.Models.Payment", b =>
                {
                    b.HasOne("dotnet_backend.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("dotnet_backend.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
